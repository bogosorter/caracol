...
pub const CAMERA_POSITION: Vector = Vector::new(0., 3., 8.);
pub const LOOK_AT: Vector = Vector::new(0., 3., 0.);
...
pub fn create_scene() -> Vec<Arc<dyn SceneElement>> {
    let mut elements = read_obj("src/assets/bunny.obj", Arc::new(ReflectiveMaterial::new(
    ...
    elements.push(Arc::new(Triangle::new(
        ...
        Vector::new(-3., 6., -3.),
        Vector::new(-3., 6., 3.),
        Arc::new(DiffuseMaterial::new(Vector::new(1., 0., 0.), 0.))
    )));
    elements.push(Arc::new(Triangle::new(
        Vector::new(-3., 6., 3.),
        Vector::new(-3., 0., 3.),
    ...
    elements.push(Arc::new(Triangle::new(
        ...
        Vector::new(3., 6., 3.),
        Vector::new(3., 6., -3.),
        Arc::new(DiffuseMaterial::new(Vector::new(0., 1., 0.), 0.))
    )));
    elements.push(Arc::new(Triangle::new(
        Vector::new(3., 6., 3.),
        Vector::new(3., 0., -3.),
